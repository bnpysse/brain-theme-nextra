...
&lt;table&gt;
&lt;tr&gt;
  &lt;td align="center" width="33%"&gt;![Architecture](docs/screenshots/architecture.png)  
**Architecture**  
&lt;sub&gt;Components + connections&lt;/sub&gt;&lt;/td&gt;
  &lt;td align="center" width="33%"&gt;![Flowchart](docs/screenshots/flowchart.png)  
**Flowchart**  
&lt;sub&gt;Decision logic&lt;/sub&gt;&lt;/td&gt;
  &lt;td align="center" width="33%"&gt;![Sequence](docs/screenshots/sequence.png)  
**Sequence**  
&lt;sub&gt;Messages over time&lt;/sub&gt;&lt;/td&gt;
&lt;/tr&gt;
&lt;tr&gt;
  &lt;td align="center"&gt;![State machine](docs/screenshots/state.png)  
**State machine**  
&lt;sub&gt;States + transitions&lt;/sub&gt;&lt;/td&gt;
  &lt;td align="center"&gt;![ER](docs/screenshots/er.png)  
**ER / data model**  
&lt;sub&gt;Entities + fields&lt;/sub&gt;&lt;/td&gt;
  &lt;td align="center"&gt;![Timeline](docs/screenshots/timeline.png)  
**Timeline**  
&lt;sub&gt;Events on an axis&lt;/sub&gt;&lt;/td&gt;
&lt;/tr&gt;
&lt;tr&gt;
  &lt;td align="center"&gt;![Swimlane](docs/screenshots/swimlane.png)  
**Swimlane**  
&lt;sub&gt;Cross-functional flow&lt;/sub&gt;&lt;/td&gt;
  &lt;td align="center"&gt;![Quadrant](docs/screenshots/quadrant.png)  
**Quadrant**  
&lt;sub&gt;Two-axis positioning&lt;/sub&gt;&lt;/td&gt;
  &lt;td align="center"&gt;![Nested](docs/screenshots/nested.png)  
**Nested**  
&lt;sub&gt;Hierarchy by containment&lt;/sub&gt;&lt;/td&gt;
&lt;/tr&gt;
&lt;tr&gt;
  &lt;td align="center"&gt;![Tree](docs/screenshots/tree.png)  
**Tree**  
&lt;sub&gt;Parent → children&lt;/sub&gt;&lt;/td&gt;
  &lt;td align="center"&gt;![Org chart](docs/screenshots/org-chart.png)  
**Org chart**  
&lt;sub&gt;Ownership + routing&lt;/sub&gt;&lt;/td&gt;
  &lt;td align="center"&gt;![Venn](docs/screenshots/venn.png)  
**Venn**  
&lt;sub&gt;Set overlap&lt;/sub&gt;&lt;/td&gt;
&lt;/tr&gt;
&lt;tr&gt;
  &lt;td align="center"&gt;![Layers](docs/screenshots/layers.png)  
**Layer stack**  
&lt;sub&gt;Stacked abstractions&lt;/sub&gt;&lt;/td&gt;
  &lt;td align="center"&gt;![Pyramid](docs/screenshots/pyramid.png)  
**Pyramid / funnel**  
&lt;sub&gt;Ranked hierarchy or drop-off&lt;/sub&gt;&lt;/td&gt;
  &lt;td align="center"&gt;![Consultant 2×2](docs/screenshots/quadrant-consultant.png)  
**Consultant 2×2**  
&lt;sub&gt;Scenario matrix · named cells&lt;/sub&gt;&lt;/td&gt;
&lt;/tr&gt;
&lt;tr&gt;
  &lt;td align="center"&gt;![Radar](docs/screenshots/radar.png)  
**Radar / Spider**  
&lt;sub&gt;Multi-axis comparison&lt;/sub&gt;&lt;/td&gt;
  &lt;td align="center"&gt;![Loop](docs/screenshots/loop.png)  
**Loop**  
&lt;sub&gt;Flywheel · stations around a hub&lt;/sub&gt;&lt;/td&gt;
  &lt;td align="center"&gt;![IT current-state](docs/screenshots/it-state.png)  
**IT current-state**  
&lt;sub&gt;Legacy landscape · modernization&lt;/sub&gt;&lt;/td&gt;
&lt;/tr&gt;
&lt;tr&gt;
  &lt;td align="center"&gt;![High-Level](docs/screenshots/high-level.png)  
**High-Level**  
&lt;sub&gt;End-to-end stack on a cluster&lt;/sub&gt;&lt;/td&gt;
  &lt;td align="center"&gt;![Bar chart](docs/screenshots/bar.png)  
**Bar chart**  
&lt;sub&gt;Categorical comparison&lt;/sub&gt;&lt;/td&gt;
  &lt;td align="center"&gt;![Line chart](docs/screenshots/line.png)  
**Line chart**  
&lt;sub&gt;Trends over time&lt;/sub&gt;&lt;/td&gt;
&lt;/tr&gt;
&lt;tr&gt;
  &lt;td align="center"&gt;![Gantt](docs/screenshots/gantt.png)  
**Gantt**  
&lt;sub&gt;Tasks and phases on a timeline&lt;/sub&gt;&lt;/td&gt;
  &lt;td align="center"&gt;![Scatter plot](docs/screenshots/scatter.png)  
**Scatter plot**  
&lt;sub&gt;Distribution and correlation&lt;/sub&gt;&lt;/td&gt;
  &lt;td align="center"&gt;![Process](docs/screenshots/process.png)  
**Process**  
&lt;sub&gt;Multi-actor sequential workflow&lt;/sub&gt;&lt;/td&gt;
&lt;/tr&gt;
&lt;tr&gt;
  &lt;td align="center"&gt;![Medallion](docs/screenshots/medallion.png)  
**Medallion**  
&lt;sub&gt;Multi-tier data storage&lt;/sub&gt;&lt;/td&gt;
  &lt;td align="center"&gt;![Data flow](docs/screenshots/data-flow.png)  
**Data flow**  
&lt;sub&gt;Role-scoped pipeline steps&lt;/sub&gt;&lt;/td&gt;
  &lt;td align="center"&gt;![DP integration](docs/screenshots/dp-integration.png)  
**DP integration**  
&lt;sub&gt;Sources → core → consumers&lt;/sub&gt;&lt;/td&gt;
&lt;/tr&gt;
&lt;tr&gt;
  &lt;td align="center"&gt;![DP security matrix](docs/screenshots/dp-security-matrix.png)  
**DP security matrix**  
&lt;sub&gt;Per-role access permissions&lt;/sub&gt;&lt;/td&gt;
  &lt;td&gt;&lt;/td&gt;
  &lt;td&gt;&lt;/td&gt;
&lt;/tr&gt;
&lt;/table&gt;
