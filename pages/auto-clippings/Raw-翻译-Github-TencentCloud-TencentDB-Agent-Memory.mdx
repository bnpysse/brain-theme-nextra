---
title: "_TencentCloud_TencentDB-Agent-Memory_全翻译"
tags: ["Github_Trending", "全文翻译"]
---

&lt;div align="center"&gt;

![TencentDB Agent Memory](./assets/images/logo.png)

### Agents remember. Humans innovate.

&lt;a href="https://trendshift.io/repositories/29310?utm_source=repository-badge&amp;utm_medium=badge&amp;utm_campaign=badge-repository-29310" target="_blank" rel="noopener noreferrer"&gt;![TencentCloud%2FTencentDB-Agent-Memory | Trendshift](https://trendshift.io/api/badge/repositories/29310)&lt;/a&gt;
...
![image.png](assets/images/chat_memory.cn.png)
...
![image.png](assets/images/skill.cn.png)
...
![image.png](./assets/images/wiki.cn.png)

- **CodeGraph** indexes code symbols, files, call relationships, and impact paths.
![image.png](assets/images/codegraph.cn.png)
...
![image.png](assets/images/asset.cn.png)
...
![Cold Start: import codebase, docs, and history into Memory Hub](assets/images/flowchart3.png)
...
![Every Loop Gains Experience: continuous accumulation, making every use smarter](assets/images/flowchart4.png)
...
![Technical overview: layering (L0–L3), Memory Assets, Memory Hub, identity-based assembly for Agents](assets/images/flowchart5.png)
