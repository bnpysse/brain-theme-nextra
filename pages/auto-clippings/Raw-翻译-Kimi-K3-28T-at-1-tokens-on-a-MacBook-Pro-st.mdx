---
title: "Kimi K3 2.8T at 1 tokens on a MacBook Pro, streamed from fou_全翻译"
tags: ["大咖视点_全文翻译", "Hacker_News_Top_(硅谷极客风向标)"]
---

【文章标题】：Kimi K3 (2.8T) at 1 token/s on a MacBook Pro, streamed from four SSDs
...
./target/release/deltafin serve --host 127.0.0.1 --port 8000curl http://127.0.0.1:8000/v1/chat/completions \
