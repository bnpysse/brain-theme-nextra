...
![LoopX loop engineering social preview banner](docs/assets/loopx-social-preview.png)
...
&lt;a href="docs/assets/long-running-loop-openviking-trajectory.png"&gt;
  ![Open-source issue-fix trajectory linking focused PR delivery with reusable LoopX capabilities](docs/assets/long-running-loop-openviking-trajectory.png)
&lt;/a&gt;
...
&lt;a href="docs/assets/long-running-loop-ml-experiment-trajectory.png"&gt;
  ![Auto ML Experiment trajectory with experiment lineages, evidence gates, and promotion decisions](docs/assets/long-running-loop-ml-experiment-trajectory.png)
&lt;/a&gt;
...
&lt;a href="docs/assets/auto-research-multi-agent-showcase.png"&gt;
  ![Auto Research multi-agent workspace with proposer, executor, evaluator/promoter, todo, quota, evidence, and targeted wake activity](docs/assets/auto-research-multi-agent-showcase.png)
&lt;/a&gt;
