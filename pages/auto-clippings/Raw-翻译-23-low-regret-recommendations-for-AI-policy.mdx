...
【文章标题】：23 low-regret recommendations for AI policy
...
几天前，我发布了进步研究所（Institute for Progress）的蒂姆·菲斯特（Tim Fist）和赛义夫·汗（Saif Khan）撰写的一篇客座文章，讨论了是否应该刻意放慢人工智能发展速度的问题：
...
作者们承诺会提出一系列具体的政策建议，他们没有让人失望。这是第二部分，包含了所有这些建议。你知道吗，23是我的幸运数字？
...
中，我们评估了人工智能公司员工最近发表的一封公开信的主张，该信呼吁各国政府“把控”前沿人工智能发展的节奏。总结如下：
...
迈向全自动化人工智能研发的快速进展有实证支持，但尚不清楚它会在多大程度上加速人工智能能力或带来严重风险。
...
尽管存在巨大的不确定性，我们仍然认为采取一些预备性的政策行动是必要的。这既源于潜在直接风险的严重性，也源于政治反弹可能导致诸如全面禁止新建数据中心等考虑不周的政策措施的风险。
...
如果“把控节奏”确有必要，我们认为它应该包含两个部分：第一，明确自动化人工智能研发可能构成严重风险的门槛；第二，一旦超过门槛，激励人工智能公司将资源从最高风险的研究转向使进一步自动化更安全的活动，或更快地传播现有人工智能的收益。
...
然而，如果现在不做好准备，我们偏好的节奏把控策略将无法实施。在本文中，我们将描述美国如何具体地为人工智能研发的进一步自动化及其带来的风险做好准备。
...
：为自动化人工智能研发制定风险管理战略，加速防御性和商业性人工智能应用
...
：加速发展能提高社会抵御人工智能驱动的破坏并从中恢复的能力的技术
...
：扩大美国在人工智能领域对中国的领先优势，以争取更多时间管理风险，并增加美国在国际谈判中的筹码
...
在本文的其余部分，我们将解释为什么我们认为在每个领域采取政策行动是合理的，并为每个领域提出具体建议。关于这一点以及
...
个月翻一番。但在前沿人工智能公司之外，人工智能进步的驱动因素——例如，整理更多更好的数据、改进训练算法、应用更多强化学习、简单地扩大模型规模——究竟如何解锁人工智能能力，人们知之甚少。
...
围绕人工智能研发自动化的许多关键问题也是如此。许多最优质的信息仍留在公司内部。
...
鉴于自动化研发可能在几乎没有预警的情况下迅速加速人工智能进步，这种动态可能使政府和公众毫无准备。
...
事情不必如此。如果我们希望社会做出良好反应，我们需要更多关于人工智能前沿动态的信息。
...
更高的透明度可以帮助我们理解自动化人工智能研发背后的科学原理，以及它在特定公司内部的实际形态（例如，他们自动化了多少流程、使用什么政策来管理风险，以及任何与研发相关的事件）。

A recent NVIDIA-led letter

最近一封由英伟达（NVIDIA）牵头的公开信
...
从开放科学的角度支持开放权重模型——这是一个有价值的目标。但围绕人工智能开发科学和常见实践（对于封闭权重和开放权重模型而言）的公开披露实践却少之又少。
...
公司的“模型行为规范”，即描述人工智能模型被训练遵循的价值观和原则的文件（例如，OpenAI为其GPT模型制定的Model Spec，以及Anthropic为其Claude模型制定的Constitution）。
...
这些信息中的绝大多数不受披露要求的约束，因此要么以有限的方式自愿披露，要么根本不披露。
...
尽管一些特别敏感的信息可能只适合向美国政府披露，但我们通常建议采取涉及公开披露的透明度措施。
...
随着人工智能公司将其研发自动化程度提高，这些信息将增强公众和政策制定者的理解，改善政策应对，并使更广泛的科学界能够在对齐和安全方面做得更好。
...
1. 前沿人工智能公司和相关行业机构应公开分享与人工智能研发自动化趋势和风险相关的信息
...
上述信息类别将提高政策制定者和公众对前沿人工智能公司研发自动化程度和性质的理解，使外部专家能够
...
趋势和影响。反过来，这将改善政策应对，并加强更广泛科学界在对齐和安全方面的工作。
...
披露人工智能科学和通用人工智能能力的信息将回归美国人工智能行业开放科学出版的历史规范。就在2020年，OpenAI
...
关于GPT-3架构、训练方法和数据的详细信息，而在2022年，谷歌
...
详细的扩展定律，展示了训练计算、数据和模型架构如何与人工智能模型能力相关联。
...
为了重建这一规范，前沿人工智能公司的员工应鼓励其领导层公开分享上述类别的信息，并倡导重建更广泛的行业规范，包括通过
...
我们相信，围绕这些信息敏感性的商业和地缘政治担忧是可以管理的。与人工智能科学和通用人工智能能力相关的行业级技术指标，美国和中国的大多数或所有前沿人工智能公司可能都已充分了解。因此，它们不太可能改变美国人工智能公司之间以及美国与中国之间的人工智能能力平衡。此外，具体的公司级人工智能研发自动化活动具有极大的公共利益，因此提高美国政府和公众制定政策应对的能力，超过了商业敏感性的担忧。当然，一些关于尖端突破的具体信息——尤其是在非美国公司缺乏可比知识的情况下——将对美国的战略利益和人工智能领导地位至关重要，因此可能不太适合公开披露。
...
然而，我们不建议通过法律强制要求披露这些信息。法律强制公开披露应侧重于与风险管理相关的信息，具体如下。
...
》（2026年7月提出）包含以下三类与内部部署模型（通常用于自动化人工智能研发）直接相关的透明度和报告义务：（1）开发者公开的前沿人工智能框架必须描述开发者在决定内部部署模型时如何审查风险评估；（2）开发者必须定期向商务部提交保密报告，内容包括“其前沿模型内部使用所产生的灾难性风险评估摘要”；（3）开发者必须在72小时内报告涉及其前沿模型的重大安全事故，包括事故是否与内部使用有关。
...
》（2026年6月提出）将要求对仅限内部使用的人工智能模型进行报告，包括对于“在未受提示的情况下，已展示出能够实质性加速或自动化先进人工智能系统的研究、开发、评估、工程或改进的能力，包括可能显著压缩更强系统开发或部署时间线的方式”的内部模型。
...
（2025年5月提出）将加强对举报人的保护，涉及人工智能安全漏洞、违法行为或对公共安全、公共卫生或国家安全构成危险的风险活动。
...
上述法案将有效强制公开披露前沿人工智能框架，以及政府披露内部部署模型的事件报告，并保护举报人。有必要制定新的立法来强制披露模型行为规范。一些法案，如《前沿法案》，包含了比公开披露广泛得多的监管范围——但讨论这些条款超出了本报告的范围。
...
目前，美国政府缺乏资源充足的机构来充分跟上人工智能研发自动化，为政治家和前沿人工智能公司提供如何应对的建议，或协调节奏把控战略。
...
然而，如果没有一个被社会各界广泛信任的国家权威机构，管理人工智能能力快速提升的节奏将是不可能的。只有对民主负责的领导者才拥有合法性和权力来协调可能需要的向防御和传播方向的大规模资源重新分配。

The government should therefore build institutions capable of responding effectively to rapid AI progress.

因此，政府应建立能够有效应对人工智能快速进步的机构。
...
3. 国会应每年至少为人工智能标准与创新中心（CAISI）提供8400万美元的预算，并授权其直接为政府高级官员和前沿人工智能公司提供建议

Congress should provide CAISI with the manpower, resources, and autonomy required to generate real situational awareness of AI progress for policymakers and shape frontier AI companies’ technology development and incentives. IFP previously recommended

国会应向CAISI提供所需的人力、资源和自主权，以便为政策制定者